        ...
        <div key={id}>
            <div className=''>
                <div className='flex items-center gap-2'>
                    ...
                    <span className='text-sm'>Ptengine</span>
                </div>
                <div className={`${s.answerWrap}`}>
                    <div className={`${s.answer} relative text-sm text-gray-900`}>
                        <div className={`ml-2 py-3 px-[24px] rounded-tr-2xl rounded-b-2xl ${workflowProcess && 'min-w-[480px]'}`}>
                            {workflowProcess && (
