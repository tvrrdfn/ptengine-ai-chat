...
const Main: FC = () => {
    ...
    */
    ...
    const handleStartChat = (inputs: Record<string, any>, query?: string) => {
        createNewChat(query)
    ...
    const handleStartChatForTab = (query: string) => {
        const inputs = {};
        createNewChat(query)
        setConversationIdChangeBecauseOfNew(true)
        setCurrInputs(inputs)
    ...
    */
    ...
    const createNewChat = (query?: string) => {
    ...
    const handleSend = async (message: string, files?: VisionFile[]) => {
        console.log('handleSend', message, files);
